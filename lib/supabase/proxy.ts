...
export async function updateSession(request: NextRequest) {
  ...
  // Keep the public preview usable when Supabase is intentionally not configured.
  // Authenticated features remain unavailable until the project supplies these values.
